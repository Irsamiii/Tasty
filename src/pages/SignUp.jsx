  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex w-1/2 bg-black flex-col items-center justify-center">
        ...
        <p className="text-gold-default italic">Crafted for your cravings</p>
      </div>

      <div className="w-full lg:w-1/2 bg-white p-8 flex items-center justify-center">
        <div className="max-w-md w-full">
          <h2 className="text-gold-default font-semibold mb-1">GET STARTED</h2>
          <h1 className="text-3xl font-bold mb-2">Let's build your <br /> <span className='text-gold-default'> account.</span></h1>
          ...
          <p className="text-center mt-6 text-gray-600">
            ...
            <a href="/signin" className="text-gold-default font-semibold hover:text-gold-light hover:underline">Sign in</a>
          </p>
        </div>
      </div>
    </div>
